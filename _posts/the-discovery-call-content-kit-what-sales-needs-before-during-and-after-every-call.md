---
title: "The Discovery Call Content Kit: What Sales Needs Before, During, and
  After Every Call"
excerpt: 82% of B2B decision-makers say reps arrive unprepared. 60% of sales
  leaders say poor discovery is the number one reason deals are lost. The
  content kit that fixes both problems is simpler than most teams build.
...
metaTitle: "The Discovery Call Content Kit: What Sales Needs Before, During, and
  After Every Call"
metaDescription: 82% of B2B decision-makers say reps arrive unprepared. 60% of
  sales leaders say poor discovery is the number one reason deals are lost. The
  content kit that fixes both problems is simpler than most teams build.
primaryKeyword: The Discovery Call Content Kit
secondaryKeywords:
  - sales discovery process
  - discovery call preparation
  - Gong talk track
  - B2B sales enablement
  - sales discovery statistics
---
...
One process note: the talk-to-listen ratio on a discovery call should be 43% talking to 57% listening, per the Gong Labs analysis originally published by Chris Orlob and later updated by Dan Morgese. ([Source: Gong.io](https://www.gong.io/blog/talk-to-listen-conversion-ratio)). The during reference should not tempt reps to fill silence. It should give them permission to stop.
...
Gong Labs' analysis of over 300 million sales calls shows that top performers consistently identify a recent trigger at the prospect's company, a funding event, leadership change, product launch, or public statement of a business problem, before the call. This trigger shapes the opening question and the pre-call hypothesis. Chris Orlob, who led Gong Labs and helped scale Gong to $200M ARR, describes this as finding "the need behind the need": surface-level research leads to surface-level conversations that do not progress to qualified opportunities. ([Source: gong.io](https://www.gong.io/blog/nailing-your-sales-discovery-calls))
